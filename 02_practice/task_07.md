# Практическое задание 7. Знакомство с Ansible
...
5. Напишите playbook выполняющий сценарий (скрипт) с названием "snap", который на серверах из группы "universe" из каталога "/lifeforms" удалит половину файлов. Известно, что в этом каталоге файлов чётное количество и при этом файлов заканчивающихся на 1 столько же, сколько и файлов заканчивающихся на 2.
